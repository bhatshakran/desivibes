        ...
        <div className='-mx-4 flex flex-wrap'>
          <div className='w-full px-4 sm:w-2/3 lg:w-3/12'>
            <div className='mb-10 w-full'>
              <a
                href=''
                className='mb-6 inline-block font-josefinsans text-primary text-[48px]'
              >
                DesiVibes
              </a>
              <p className='text-subtext mb-7 text-base'>
          ...
          <div className='w-full px-4 sm:w-1/2 lg:w-2/12'>
            <div className='mb-10 w-full'>
              <h4 className='text-dark mb-9 text-lg font-semibold font-josefinsans'>
                Categories
              </h4>
              <ul>
                <li>
          ...
          <div className='w-full px-4 sm:w-1/2 lg:w-3/12'>
            <div className='mb-10 w-full'>
              ...
              <p className='text-subtext text-base'>&copy; 2023 Desivibes</p>
            </div>
          </div>
        </div>
      </div>
